...
<div class="sideBar-ontoggle --hidden">
  ...
  <div class="sideBar__icons">
    ...
    @endif
    @if(in_array('issuance', $allowedPages))
    <a href="/issuance" class="sideBar__issuance sideBar__icon {{ $title === 'Issuance' ? '--selectedBtnUi' : '' }}" style="text-decoration: none; color: inherit;">
      <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
